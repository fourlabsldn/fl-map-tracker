...
Point.prototype.with = curry$2(function (prop, val) {
  // eslint-disable-line prefer-arrow-callback
 ...
 */
const removeMissingPoints = curry$2((mapDriver, oldPoints, newPoints) => {
 ...
 */
const moveChangedPoints = curry$2((mapDriver, oldPoints, newPoints) => {
...
var _mapping = createCommonjsModule$$1(function (module, exports) {
/** Used to map aliases to their real names. */
exports.aliasToReal = {
...
function GMap(google) {
  ...
  function addressToLatLng(address, apiKey = DEFAULTS.apiKey) {
    ...
    return fetch(url).then(r => r.json()).then(get('results[0].geometry.location'));
  }
